...
class RNN(nn.Module):
    def __init__(self, input_layer, hidden_layer, number_layer, output_layer, output_per_layer= 24):
        ...
        self.fc = nn.ModuleList([nn.Linear(self.hidden_layer, output_layer) for _ in range(output_per_layer)])
